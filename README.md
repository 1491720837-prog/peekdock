...
**把 AI 的等待，交给桌面伙伴。** PeekDock 把 Codex、Claude Code、即梦与其他 Agent 的真实异步任务状态统一显示在 ESP32 小屏。
...
PeekDock 诞生于开发者日常工作中的一个小痛点：我们每天都在重度使用 AI Coding，Claude、Codex、Cursor 这类工具。接到一个任务后，往往需要运行十几分钟，而这段等待时间一直很尴尬——刷个小视频，可能就错过了电脑上的 AI 授权请求；离开电脑，担心错过关键决策节点；留在电脑前，却又只能空等。有时切去浏览其他网页，再回头时，终端里的重要提示早已被聊天窗口盖住。

我们后来意识到，问题的根源是人和 AI 共享了同一块屏幕、同一份注意力：工作空间混在一起，状态提示也混杂在一起。

所以我们做了 PeekDock，把 AI 的工作从主屏剥离出来，装进这枚小小的硬件里。AI 在那边运行，人可以自由做自己的事；只有当它需要决策时，才会主动叫你回来关注。
...
PeekDock 把这种“等待管理”从主屏剥离出来：主屏继续创作，小屏用拟人化角色告诉你谁在工作、谁需要输入、谁已经交付。它不是阅读长内容的副屏，而是一块由真实 AI 事件驱动的低打扰团队状态面板。PeekDock 解决的是多种 AI 工具并行使用后产生的状态分散、频繁切屏和注意力损耗问题。它把多个 AI 任务统一托管起来，让用户轻松掌握 AI 的工作进度，并通过语音输入、快速发送和 Agent 切换等快捷操作降低操作摩擦。为了管理这些 AI 任务，用户原本需要付出屏幕空间、切屏时间、注意力和记忆成本；PeekDock 要替用户承担这部分低价值的管理负担，让用户保持心流，把精力留给判断、创造和决策。
...
**为什么做在硬件上？** 人与 AI 已经进入新的协作形态：人正从亲自执行任务的劳动者，转变为在关键时刻监督状态、做出决策的管理者。但今天的 IDE 和桌面仍然为“亲自劳动”而设计——AI 已经在帮我们工作，人的注意力却还没有下班，人和 AI 依然挤在同一块屏幕上。桌面首先是属于人的工作空间，人的注意力空间与 AI 的任务空间需要清晰分区，因此物理隔离不是装饰，而是新协作关系所需要的边界。PeekDock 把 AI 状态与任务流从主屏中独立出来，让人真正离开屏幕，只在重要时刻介入，更好地管理 AI，也更好地管理自己的注意力。
