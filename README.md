...
PeekDock 起因于开发者日常工作中的一个小痛点：我们每天都在重度使用 AI Coding，Claude、Codex、Cursor 这类工具接到一个任务后，往往需要运行十几分钟，而这段等待时间一直很尴尬——刷个小视频，可能就错过了电脑上的 AI 授权请求；离开电脑，担心错过关键决策节点；留在电脑前，却又只能空等。有时切去浏览其他网页，再回头时，终端里的重要提示早已被聊天窗口盖住。
